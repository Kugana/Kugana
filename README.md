...
* 🎮 Focus on **game systems + immersive UI/UX**

---

## 🧩 Current Focus

* 🔥 AI + Education (LearnUp)
* ⚡ Reinforcement Learning Trading Systems (AlphaFlow)
* 🧱 Minecraft Advanced Systems (Shaders, HUD, Plugins)
* 🧠 Smart Memory AI Architecture
...
![Spigot](https://img.shields.io/badge/Spigot-F7DF1E?style=for-the-badge)
...
![Stable-Baselines3](https://img.shields.io/badge/RL-PPO-blue?style=for-the-badge)
...
### 🎓 LearnUp — AI Learning Platform

* Daily AI-generated vocabulary system
* Smart memory tracking & spaced learning
* Multi-language support + audio system optimization

---

### 📈 AlphaFlow — AI Trading System

* Transformer-based prediction models
* Reinforcement Learning (PPO)
* Real-market simulation (slippage, fees, risk control)
...
I combine **game design, AI, and system engineering**
to build things most people never attempt.
